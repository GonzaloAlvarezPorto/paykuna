        ...
        <div className='order_form'>
            ...
            <div className='form_btns'>
                <div className='btns_update'>
                    ...
                    <PagadoInput totalPedido={pedido.total} pagadoInicial={pedido.pagado ?? 0} pedidoId={pedido.id} />
                </div>
                <div className='btns_state'>
                    <p><strong>Modificar estado: </strong></p>
                    <EstadoButtons totalPedido={pedido.total} estadoActual={pedido.estado} pedidoId={pedido.id} />
                </div>
            </div>
